 ...
 */
public class BasicDriveAndSnorfler extends OpMode {
    ...
    public void init() {
        ...
        motorSnorfler = hardwareMap.dcMotor.get("motorSnorfler");
     ...
     */
            ...
            //This code will rotate Snorfler when button is held down
            if (gamepad2.b)  {
                motorSnorfler.setPower(SNORFSPEED);
            } else {
                motorSnorfler.setPower(STOPMOTOR);
            }
        }
